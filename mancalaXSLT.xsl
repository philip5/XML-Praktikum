			...
			<body>
				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
					...
					<defs>
						...
						<!-- House player 1 -->
						<circle id="house-p1" cy="17.5%" r="7%" stroke="black"
							stroke-width="5" fill="peru" />
						<!-- House player 2 -->
						<circle id="house-p2" cy="52.5%" r="7%" stroke="black"
							stroke-width="5" fill="peru" />
						<!-- Button -->
						<rect id="button" y="77%" width="15%" height="6%" stroke="black"
							stroke-width="5" fill="saddlebrown" />

					</defs>

					<!-- Background -->
					<svg>
						<rect rx="20" ry="20" width="100%" height="70%" fill="white"
							stroke="black" stroke-width="5" />

						<svg>
							<rect x="13%" rx="20" ry="20" width="74%" height="70%"
								fill="saddlebrown" stroke="black" stroke-width="5" />
						</svg>
					</svg>

					<svg>
						<text x="50%" y="76%" font-size="50" fill="darkred"
							text-anchor="middle">MANCALA</text>
					</svg>
					<g>
						<use id="btn-newgame" xlink:href="#button" x="42.5%" />
						<text x="50%" y="81%" font-size="25" fill="black"
							text-anchor="middle">NEW GAME</text>
					</g>


					<!-- Stores -->
					<use id="store-p1" xlink:href="#store" x="7%" y="35%" stroke="black"
						fill="saddlebrown" />
					<use id="store-p2" xlink:href="#store" x="93%" y="35%" stroke="black"
						fill="saddlebrown" />
